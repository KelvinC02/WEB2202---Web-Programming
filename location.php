...
<body>
    ...
    <main class="my-5">
      <div class="container p-4" style="background-color: #FCF8E8; border-radius: 20px;">
        <div class="row">
          <div class="col-md-6">
            <img src="media/logo2.png" alt="" width="250px" height="300px" style="margin-left:20px ;">
          </div>
          <div class="col-md-5" style="align-items:center ; align-self:center;">
            <h2>Factory Location</h2>
            <p>Our Factory provides supports and services such as accepting donation in the form of unused products. Public is allowed to pay a visit to our factory too with appointment in prior!</p>
          </div>
        </div>
      </div>
      <div class="row row-cols-1 row-cols-md-2 g-4 m-3">
        <div class="col">
          <div class="card">
            <img src="media/factory.jpg" class="card-img-top" alt="" height="400px">
            <div class="card-body">
              <h5 class="card-title">Petaling Jaya</h5>
              <p class="card-text">Jalan PJS 7/17, Bandar Sunway, 46150 Petaling Jaya, Selangor</p>
              <button type="button" class="btn btn-primary">Show Direction</button>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card">
            <img src="media/factory2.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title">Shah Alam</h5>
              <p class="card-text">Jalan Jurunilai U1/20, Hicom Glenmarie Industrial Park, Selangor, 40150 Shah Alam</p>
              <button type="button" class="btn btn-primary">Show Direction</button>
            </div>
          </div>
        </div>
