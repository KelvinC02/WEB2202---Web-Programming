...
<div id="shopping-cart">
    ...
    if(isset($_SESSION["cart_item"])){
        ...
        <table class="tbl-cart" cellpadding="10" cellspacing="1">
                ...
                <tr>
                    ...
                    <td style="text-align:center;">
                        ...
                        <a href="cart.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction">
                            <img src="media/icon-delete.png" alt="Remove Item" /></a></td>
                </tr>
                <?php
            ...
            <input class="btn btn-primary" type="submit" value="CheckOut" onclick="location.href='checkout.php'" style="float: right; margin: 10px">
        <?php
    } else {
        ?>
        <!-- When cart is empty  -->
