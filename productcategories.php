...
<body>
    ...
    <main class="mt-5">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="card text-bg-dark my-5 ms-4 me-2">
                    <a href="secondhandproduct.php">
                        <img src="media/secondhand.png" class="card-img" alt="..." height="400px">
                    </a>
                    <div class="card-img-overlay" style="margin-top:250px ;">
                      <h5 class="card-title">Second-Hand Product</h5>
                      <p class="card-text">All the Second-Hand Product is refurbished and the quality is assured by us</p>
                      <p class="card-text"><small></small></p>
                    </div>
                  </div>
            </div>
            <div class="col-sm-6 overflow-hidden">
                <div class="card text-bg-dark my-5 ms-2 me-4">
                    <a href="recyclableproduct.php">
                        <img src="media/recycle.jpg" class="card-img" alt="..." height="400px">
                    </a>
                    <div class="card-img-overlay" style="margin-top:250px ; color: goldenrod;">
                      <h5 class="card-title">Recyclable Product</h5>
                      <p class="card-text">All the products are hand-made by our factory workers with quality assured</p>
                      <p class="card-text"><small></small></p>
                    </div>
                  </div>
            </div>
