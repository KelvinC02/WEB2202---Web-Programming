...
<head>
    ...
    <title>Recyclable Product</title>
...
<main class="mt-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <h3><u>Recyclable Items</u></h3>
                <div class="row">
                    <div class="col">
                        <!-- Product Grid  -->
                        <div id="product-grid">
                            <?php
                            $product_array = $db_handle->runQuery("SELECT * FROM product WHERE product_type = '"."Recyclable-Items"."' ORDER BY id ASC");
