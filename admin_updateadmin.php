...
if (isset($_POST["update_admin"])) {
    ...
    if ($password != $password1) {
            echo '<script>
                ...
                document.location = "admin_updateadmin.php";
                </script>';
            ...
            if ($upload) {
                echo '<script>alert("Admin Update Successfully!");
                        document.location="admin_admin.php"</script>';
            } else {
                $message[] = "Admin fail to update";
            }
        }
};
    ...
    <div class="admin-product-form-container">
        ...
        while ($row = mysqli_fetch_assoc($select)) {
            ...
            <form action="<?php $_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
                ...
                <input type="submit" class="btn" name="update_admin" value="Update Admin">
                <a href="admin_admin.php" class="btn">Go Back</a>
            </form>
        <?php }; ?>
    </div>
</body>
